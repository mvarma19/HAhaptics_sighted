...
//
        ...
        continue_trial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.show();
                fileWriteString = "practice PIN"+"," + String.valueOf(evalPW) +","+"Trial no"+ "," + trial +","+"Start time"+ "," + String.valueOf(startTime) +","+"Calender time"+ "," + String.valueOf(Calendar.getInstance().getTimeInMillis()) +","+ "Required PIN"+"," + String.format("%04d", evalPW) +","+ "Entered PIN"+"," + pw +","+ "Date"+"," + HAMorseCommon.dateTime() + "\n";
